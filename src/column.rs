...
impl<'a, const N: usize, Message: Clone, Theme: Clone, Renderer: iced_core::Renderer>
    AnimatedColumn<'a, N, Message, Theme, Renderer>
{
    /// Creates a [`AnimatedColumn`]
    ///
    /// If any of the children have a [`Length::Fill`] strategy, you will need to
    /// call [`AnimatedColumn::width`] or [`AnimatedColumn::height`] accordingly.
    ...
    /// Sets the [`Padding`] of the [`AnimatedColumn`].
    pub fn padding<P: Into<Padding>>(mut self, padding: P) -> Self {
        self.0.padding = padding.into();
        self
    }

    /// Sets the width of the [`AnimatedColumn`].
    pub fn width(mut self, width: impl Into<Length>) -> Self {
        self.0.width = width.into();
        self
    }

    /// Sets the height of the [`AnimatedColumn`].
    pub fn height(mut self, height: impl Into<Length>) -> Self {
        self.0.height = height.into();
        self
    }

    /// Sets the maximum width of the [`AnimatedColumn`].
    pub fn max_width(mut self, max_length: impl Into<Pixels>) -> Self {
        self.0.max_length = Some(max_length.into().0);
        self
    }

    /// Sets the alignment of the contents of the [`AnimatedColumn`] .
    pub fn align(mut self, align: impl Into<Alignment>) -> Self {
        self.0.align = align.into();
        self
    }

    /// Sets whether the contents of the [`AnimatedColumn`] should be clipped on
    /// overflow.
...
impl<'a, const N: usize, Message: Clone, Theme: Clone, Renderer: iced_core::Renderer>
    Widget<Message, Theme, Renderer> for AnimatedColumn<'a, N, Message, Theme, Renderer>
{
...
impl<'a, const N: usize, Message: Clone + 'a, Theme: Clone + 'a, Renderer: iced_core::Renderer + 'a>
    From<AnimatedColumn<'a, N, Message, Theme, Renderer>>
    for Element<'a, Message, Theme, Renderer>
{
    fn from(value: AnimatedColumn<'a, N, Message, Theme, Renderer>) -> Self {
        Element::new(value)
    }
}
